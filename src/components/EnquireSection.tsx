...
const EnquireSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-12 pb-24 lg:pt-16 lg:pb-32 bg-white overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-black text-gray-900 tracking-tighter leading-tight mb-8">
              Enquire Now & Book <br />
              <span className="text-primary italic-serif">Your Site Visit Today!</span>
            </h2>
            
            <p className="text-gray-500 text-base md:text-lg leading-relaxed mb-10 font-medium">
              Take the first step towards your dream property. Our consultants are ready to provide a personalized walkthrough and assist with all your queries.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl p-8 md:p-12">
              ...
              >
                ...
                <input type="hidden" name="_subject" value="New Site Visit Enquiry - Porko Elite Estates" />
